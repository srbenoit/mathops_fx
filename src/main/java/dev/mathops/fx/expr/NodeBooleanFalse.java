...
/**
 * A node that represents an immutable Boolean FALSE value.
 */
final class NodeBooleanFalse extends AbstractExpressionNode {

    /** The text node that represents this object. */
    private final Text node;

    /**
     * Creates an empty {@code NodeBooleanFalse}.
     */
    NodeBooleanFalse() {

        super();

        this.node = new Text("FALSE");
    }
